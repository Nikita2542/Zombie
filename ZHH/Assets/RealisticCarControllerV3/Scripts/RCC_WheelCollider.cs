...
public class RCC_WheelCollider : RCC_Core {
    ...
    private int groundIndex = 0;        //  Current ground index of wheelhit.
    ...
    private float wheelRPM2Speed = 0f;     // Wheel RPM to Speed in km/h.
    ...
    private void Start() {
        ...
        CheckBehavior();        //	Checks selected behavior in RCC Settings first.
